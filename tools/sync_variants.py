...
def main():
    ...
    writes = [
        ...
        sync_razor('Marker', 'marker', 'Variant', 'variant', classes, tokens, added, dropped),
        sync_razor('Bubble', 'bubble', 'Variant', 'variant', classes, tokens, added, dropped),
        sync_razor('BubbleReactions', 'bubble-reactions', 'Side', 'side', classes, tokens, added,
                   dropped, member='SideClass'),
        sync_razor('BubbleReactions', 'bubble-reactions', 'Align', 'align', classes, tokens, added,
                   dropped, member='AlignClass'),
        sync_razor('Attachment', 'attachment', 'Size', 'size', classes, tokens, added, dropped,
                   member='SizeClass'),
        sync_razor('Attachment', 'attachment', 'Orientation', 'orientation', classes, tokens,
                   added, dropped, member='OrientationClass'),
        sync_razor('AttachmentMedia', 'attachment-media', 'Variant', 'variant', classes, tokens,
                   added, dropped),
